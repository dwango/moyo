...
<pre><code>
to_atom(Binary::binary()) -&gt; atom() | {error, term()}
</code></pre>
<br />

Equivalent to [`to_atom(Binary, [{encoding, utf8}])`](#to_atom-2).
